...
function SubscriptionManager({ businessId }: { businessId: string }) {
  ...
  const manual=sub.activationType&&!['razorpay','cashfree','pending'].includes(sub.activationType);
